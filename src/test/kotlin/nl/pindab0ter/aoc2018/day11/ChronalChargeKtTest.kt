...
import nl.pindab0ter.common.helpers.assertEquals
import kotlin.test.Test

class ChronalChargeKtTest {

    @Test
    fun `Grids are calculated correctly`() = assertEquals(
    ...
    @Test
    fun `Determine the power level of a 3x3 square`() = assertEquals(
        Grid(18).powerLevelFor(33, 45) to 29,
        Grid(42).powerLevelFor(21, 61) to 30,
    )

    @Test
    fun `Find the most powerful square`() = assertEquals(
